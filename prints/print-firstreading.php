...
//tabla
    ...
    function Header()
    {
        ...
        $this->Cell(52);
        // Título
        $this->Cell(98,10,' REPORTE DE  LECTURA',1,0,'C');
        $this->Ln(8);
...
$data=$imprimirmuestra->imprimir_lectura_modelo($codigoM);
$rows=$data->fetch();

//print_r($cuadrante);
//die();

$codigoLamina=$rows['frCodeLamina'];
$nombres=$rows['paName'];
...
$fechalectura=$rows['frDateFirstreading'];
...
$conclusion=$rows['frObsConclusion'];


$reNuevaMuestraSiNo=$rows['frNewSampleYesNo'];
...
$pdf->SetFont('Times','',10);
$pdf->Cell(83,10,utf8_decode("ASC-H no excluye LEIAG"),1 ,0, 'L');
...
$pdf->SetFont('Times','',10);
$pdf->Cell(102,10, utf8_decode("$fechalectura") ,1, 0,'L');
$pdf->Ln(10);
$pdf->SetFont('Times','B',10);
