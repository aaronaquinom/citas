...
<div class="container-fluid">
	...
	<p class="lead">
	Este formulario le permite registrar la muestra del paciente que se enviara al IREN CENTRO
	</p>
</div>
...
<?php
		...
		//ADMINISTRADOR
		if($datos[0]=="sample"): //la raiz de la vista
			
			if($_SESSION['tipo_sli']!="Administrador" && $_SESSION['tipo_sli']!="Muestreador" ) //usuarios que registran muestras
			{
			echo $lc->forzar_cierre_session_controlador();
			}
			require_once "./controllers/patientController.php";
			
			$classPaciente= new patientController();
				...
				<div class="panel panel-info">
					<div class="panel-heading">
						...
						<div class="panel-body">				
							<form action ="<?php echo SERVERURL;?>ajax/sampleAjax.php"  method="POST" data-form="" class="FormularioAjax" >
											...
											<div class="row">
												...
												<div class="col-xs-12 col-sm-2">
													<div class="form-group">
														...
														<div class="radio radio-primary">
															<label>
																<input type="radio" name="optionsEmbarazada" id="optionsNo" value="<?php echo base64_encode('No')?>" checked="">
																&nbsp; No
															</label>
															<label>
																<input type="radio" name="optionsEmbarazada" id="optionsSi" value="<?php echo base64_encode('Si')?>">
																&nbsp; Si
															</label>
														</div>
												...
												<div class="col-xs-12 col-sm-1">
													<div class="form-group">
														...
														<input min="0" pattern="[0-9+]{1,90}" class="form-control" type="number" name="semana-embarazo" id="txtsemana">
													</div>
												</div>
												<div class="col-xs-12 col-sm-1">
													<div class="form-group">
														<label class="control-label">Partos</label>
														<input min="0" pattern="[0-9+]{1,90}" class="form-control" type="number" name="numero-partos">
													</div>
												</div>
												<div class="col-xs-12 col-sm-1">
													<div class="form-group">
														<label class="control-label">Abortos</label>
														<input min="0" pattern="[0-9+]{1,90}" class="form-control" type="number" name="numero-abortos">
													</div>
												</div>
												...
												<div class="col-xs-12 col-sm-4">
													<div class="form-group">
														<label class="control-label">¿EXAMEN IVA?</label>
														<div class="radio radio-primary">
															<label>
																<input type="radio" name="optionsIva" value="No" checked=""> <!--valor vacio-->
																&nbsp; No
															</label>
															<label>
																<input type="radio" name="optionsIva" id="chkNo" value="Positivo">
																&nbsp; Positivo
															</label>
															<label>
																<input type="radio" name="optionsIva" id="chkYes" value="Negativo">
																&nbsp; Negativo
															</label>
												...
												<div class="col-xs-12 col-sm-2">
													<div class="form-group">
														<label class="control-label">Edad de INRESE</label>
														<input min="0" pattern="[0-9+]{1,90}" class="form-control" type="number" name="edad-rsexual">
													</div>
												</div>
												<div class="col-xs-12 col-sm-2">
													<div class="form-group">
														<label class="control-label">Numero de parejas</label>
														<input min="0" pattern="[0-9+]{1,90}" class="form-control" type="number" name="pareja-rsexual">
													</div>
												</div>
