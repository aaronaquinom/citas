...
$insRecepcion= new receptionController();
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
				<?php
					...
					echo $insRecepcion->paginador_registro_controlador($pagina[1], 10, $_SESSION['privilegio_sli'], $pagina[0], "", "", $_SESSION['busqueda_registro']);
				?>
		</div>
	</div>
</div>
