<div class="container-fluid">
	...
	<h1 class="text-titles"><i class="zmdi zmdi-gamepad zmdi-hc-fw"></i>Muestras <small>registrar</small></h1>
	</div>
	<p class="lead">
	Busque al paciente que va registrar su muestra para ser enviado al IREN CENTRO, si no lo ubica debe registrar al paciente previamente
	</p>
</div>
<div class="container-fluid">
