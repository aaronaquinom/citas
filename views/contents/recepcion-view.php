...
<div class="container-fluid">
	<ul class="breadcrumb breadcrumb-tabs">
		<li>
		  ...
		  <li>
	  		<a href="<?php echo SERVERURL;?>reception-establishment/"class="btn btn-success">
...
<?php
		...
		if($datos[0]=="recepcion"):
			...
			$classMuestra= new muestraControlador();
				...
				<div class="panel panel-info">
					<div class="panel-heading">
						...
						<div class="panel-body">				
							<form action ="<?php echo SERVERURL;?>ajax/recepcionAjax.php"  method="POST" data-form="" class="FormularioAjax" >
										...
										<div class="container-fluid">
											<div class="row">
												...
												<div class="col-xs-12 col-sm-6">
													...
													<label></label>
													<input type="date"  class="form-control" name="fecharegla-reg" required="" value="<?php echo $campos['hgFechaMuestra']; ?>" maxlength="30"  readonly>
													</div>
												</div>
