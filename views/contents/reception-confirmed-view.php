...
$insMuestra= new receptionController();
?>
	...
	<div class="panel panel-success">
		...
		<div class="panel-body">
				...
				<?php
                    ...
                    echo $insMuestra->paginador_registro_controlador($pagina[1], 10, $_SESSION['privilegio_sli'], $pagina[0], $_SESSION['tipo_sli'], $_SESSION['codigo_cuenta_sli'], "");
