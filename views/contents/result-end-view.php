<div class="container-fluid">
	...
	<p class="lead">
	Registre el resultado de las muestras que ya tienen primera lectura
	</p>
</div>
<div class="container-fluid">
...
<?php
		...
		//ADMINISTRADOR
		if($datos[0]=="result-end"):
			
			if($_SESSION['tipo_sli']!="Administrador" && $_SESSION['tipo_sli']!="Medico")
			{
				...
				<div class="panel panel-info">
					<div class="panel-heading">
						...
						<div class="panel-body">				
							<form action ="<?php echo SERVERURL;?>ajax/resultendAjax.php"  method="POST" data-form="" class="FormularioAjax" >
								...
								<input type="hidden" name="cod-lectura" value="<?php echo $lc->encryption($campos['idFirstreading']);?>">
											...
											<div class="row">
												<div class="col-xs-12 col-sm-6">
													<div class="form-group label-floating">
														...
														<input pattern="[0-9-]{1,30}" class="form-control" type="text" id="cod-lamina" name="codlamina-reg" required="" value="<?php echo $campos['frCodeLamina']; ?>" readonly>
													</div>
												...
												<div class="col-xs-12 col-sm-6">
													<div class="form-group label-floating">
													<label class="control-label" style="font-size:10px">Fecha de primera lectura</label>
													<label></label>
													<input type="date"  class="form-control" name="fecharegla-reg" required="" value="<?php echo $campos['frDateFirstreading']; ?>" maxlength="30"  readonly>
													</div>
												</div>
											</div>
										</div>
									...
									<br>
									<fieldset>
										<legend><i class="zmdi zmdi-key"></i> &nbsp;Datos de la lectura final (2da)</legend>
										<div class="container-fluid">
											<div class="row">
                            					<div class="col-xs-12 col-sm-6">
