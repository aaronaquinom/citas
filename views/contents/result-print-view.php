...
<?php
		...
		//ADMINISTRADOR
		if($datos[0]=="result-print"):
			
			if($_SESSION['tipo_sli']!="Administrador" && $_SESSION['tipo_sli']!="Tecnologo" && $_SESSION['tipo_sli']!="Medico" && $_SESSION['tipo_sli']!="Muestreador" )
			{
			echo $lc->forzar_cierre_session_controlador();
			}
			require_once "./controllers/resultController.php";
			
			$classResultado= new resultController();
			...
			if($filesP->rowCount()==1){
						...
						<div class="panel-body">				
							<form action =""  method="POST" data-form="" class="FormularioAjax" >
								...
								<input type="hidden" name="cod-empleado" value="<?php echo $lc->encryption($_SESSION['codigo_cuenta_sli']);?>">
											...
											<div class="row">
                                                <div class="col-xs-12 col-sm-6">
													<div class="form-group label-floating">
														...
														<input pattern="[0-9-]{1,30}" class="form-control" type="text" id="codigo-lamina" name="codigolamina-reg" required="" value="<?php echo $campos['reCodeLamina']; ?>" readonly>
													</div>
												...
												<div class="col-xs-12 col-sm-6">
													...
													<label></label>
													<input type="date"  class="form-control" name="fecharegla-reg" required="" value="<?php echo $campos['reDateResult']; ?>" readonly>
													</div>
												</div>
                                                <div class="col-xs-12 col-sm-6">
													<div class="form-group label-floating">
									...
									<br>
									<fieldset>
										<legend><i class="zmdi zmdi-key"></i> &nbsp;Primera lectura dados por:</legend>
									...
									<fieldset>
										...
										<div class="container-fluid">
											<div class="row">
												...
												<label class="control-label" style="font-size:10px">Nombres</label>
													<div class="form-group">
														<input class="form-control" type="text" name="neomalignas-reg" id="txtmalignas" value="<?php echo $campos['ResultadoN'];?>" readonly>
													</div>
												</div>
                                    			</div>
                                                <div class="col-xs-12 col-sm-6">
												...
												<label class="control-label" style="font-size:10px">Apellidos</label>
													<div class="form-group">
														<input class="form-control" type="text" name="neomalignas-reg" id="txtmalignas" value="<?php echo $campos['ResultadoA'];?>" readonly>
													</div>
												</div>
                                    			</div>
											</div>
				...
				<div class="text-center">
										...
										<a href="<?php echo SERVERURL;?>prints/print-resultc.php?id=<?php echo $datos[1]; ?>" target="_blank" class="btn btn-info btn-raised btn-sm"><i class="zmdi zmdi-local-printshop zmdi-hc-fw"></i>IMPRIMIR</a>
