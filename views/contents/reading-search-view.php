...
$insLectura= new firstreadingController();
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
				<?php
                    ...
                    echo $insLectura->paginador_lectura_controlador($pagina[1], 10, $_SESSION['privilegio_sli'], $pagina[0], $_SESSION['tipo_sli'], $_SESSION['codigo_cuenta_sli'],$_SESSION['busqueda_resultado']);
				?>
		</div>
	</div>
</div>
