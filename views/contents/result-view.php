<div class="container-fluid">
	...
	<h1 class="text-titles"><i class="zmdi zmdi-book  zmdi-hc-fw"></i>Resultado <small>ingresar</small></h1>
	</div>
	<p class="lead">Esta es la lista de las muestras que tienen 1RA LECTURA listos para dar resultado final
    </p>
</div>
<div class="container-fluid">
...
$insMuestra= new firstreadingController();
?>
	...
	<div class="panel panel-success">
		...
		<div class="panel-body">
				...
				<?php
                    ...
                    echo $insMuestra->paginador_lectura_controlador($pagina[1], 10, $_SESSION['privilegio_sli'], $pagina[0], $_SESSION['tipo_sli'], $_SESSION['codigo_cuenta_sli'],"");
