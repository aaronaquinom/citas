<div class="container-fluid">
	...
	<h1 class="text-titles"><i class="zmdi zmdi-book  zmdi-hc-fw"></i>Resultado <small>para registrar</small></h1>
	</div>
	<p class="lead">Esta es la lista de las muestras que tienen 1RA LECTURA listos para registrar su resultado final
    </p>
</div>
<div class="container-fluid">
	...
	<div class="panel panel-success">
		...
		<div class="panel-body">
				...
				<?php
					...
					echo $insMuestra->paginador_resultado_controlador_final($pagina[1], 10, $_SESSION['privilegio_sli'], " ");
				?>
